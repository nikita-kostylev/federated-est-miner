from pm4py.algo.simulation.playout.versions import basic_playout,priority_playout

BASIC_PLAYOUT = "basic_playout"
PRIORITY_PLAYOUT = "priority_playout"
VERSIONS = {BASIC_PLAYOUT: basic_playout.apply,PRIORITY_PLAYOUT: priority_playout.apply}
